...
namespace API.Migrations
{
    ...
    [Migration("20260426155100_AddPostsTimeline")]
    partial class AddPostsTimeline
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.AppUser", b =>
                {
                    ...
                    b.Property<int>("FeedBoostCached")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.Property<bool>("PriorityInFeed")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("SeeFollowersList")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("UnlimitedFollows")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.UserMute", b =>
                {
            ...
            modelBuilder.Entity("API.Entities.UserBlock", b =>
                {
                    b.HasOne("API.Entities.AppUser", "Blocked")
                        .WithMany()
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.AppUser", "Blocker")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Entities.UserMute", b =>
                {
                    b.HasOne("API.Entities.AppUser", "Muted")
                        .WithMany()
                        .HasForeignKey("MutedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.AppUser", "Muter")
                        .WithMany()
